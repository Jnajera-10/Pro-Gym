...
def generate_receipt_pdf(payment):
    ...
    elements = []
    elements.append(Paragraph('PRO-GYM', ParagraphStyle('title', fontSize=20, textColor=DARK, spaceAfter=4)))
...
def generate_report_pdf(tipo, data, start=None, end=None, today=None):
    ...
    elements.append(Paragraph('PRO-GYM', ParagraphStyle('brand', fontSize=18, textColor=DARK, spaceAfter=2)))
...
def generate_cierre_caja_pdf(fecha, payments, expenses, sales, opening_cash,
    ...
    # ── Pie ──────────────────────────────────────────────────────────
    elems.append(Paragraph(
        f'<font size="7.5" color="#9ca3af">PRO-GYM — Documento generado automáticamente el {generado_en} '
