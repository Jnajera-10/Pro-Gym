...
def _send_brevo(to_email: str, subject: str, html_body: str) -> tuple[bool, str]:
    ...
    mail_name = os.environ.get('MAIL_FROM_NAME', 'PRO-GYM').strip()
        ...
        <tr><td align="center">
          <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.1);">
            <tr><td style="background:#1a1a2e;padding:24px 32px;">
              <h1 style="margin:0;color:#ffffff;font-size:22px;letter-spacing:1px;">💪 PRO-GYM</h1>
            </td></tr>
            ...
            <tr><td style="background:#f8f8f8;padding:16px 32px;border-top:1px solid #eeeeee;">
              <p style="margin:0;color:#999999;font-size:12px;text-align:center;">
                Este es un mensaje automático de PRO-GYM.<br>
...
class NotificationService:
    ...
    def send_welcome(client):
        ...
        <p style="color:#555;">¡Bienvenido(a) a <strong>PRO-GYM</strong>! 🎉</p>
        ...
        """
        html = _base_template('¡Bienvenido a PRO-GYM!', contenido)
        ok, err = _send_brevo(client.email, '¡Bienvenido a PRO-GYM! 💪', html)
    ...
    def send_expiry_warning(payment, days_left: int):
        ...
        ok, err = _send_brevo(client.email, f'{emoji} Tu membresía vence {dias_texto} — PRO-GYM', html)
    ...
    def send_expired_notice(payment):
        ...
        ok, err = _send_brevo(client.email, '❌ Tu membresía en PRO-GYM ha vencido — ¡Renueva!', html)
    ...
    def send_password_reset(user):
        ...
        ok, err = _send_brevo(user.email, 'Recuperación de contraseña — PRO-GYM', html)
    ...
    def send_couple_plan_notification(partner_payment, main_client):
        ...
        ok, err = _send_brevo(partner.email, '💑 Tu Plan Pareja en PRO-GYM está activo', html)
