...
Ejecutar desde gym_system/:
    python fix_memberships.py --excel /ruta/al/REGISTRO_DIARIO_PRO-GYM_JUNIO.xlsx

Precios del gimnasio PRO-GYM:
    Diario        $5.000   (1 día)
...
def parse_args():
    ...
    p.add_argument('--excel', required=True, help='Ruta al REGISTRO_DIARIO_PRO-GYM_JUNIO.xlsx')
    return p.parse_args()
