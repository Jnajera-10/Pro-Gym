...
def pdf_cierre_caja():
    ...
    if admin and admin.email:
        ...
        html = f"""
        <h2 style="color:#1a1a2e">💪 PRO-GYM — Cierre de Caja {fecha_str}</h2>
        ...
        <p style="color:#6b7280;font-size:12px">Generado por {usuario_cierre} — PRO-GYM</p>
        """
        try:
            send_email_raw(
                to_email    = admin.email,
                subject     = f'Cierre de Caja {fecha_str} — PRO-GYM',
                html_body   = html,
